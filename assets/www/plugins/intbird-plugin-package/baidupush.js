 ...
 */
 cordova.define("intbird-plugins-package.baidupush", function(require, exports, module) {
...
function failureCallback() {
    console.error('BaiduPush got an error.');
}
...
BaiduPush.prototype.messageGet = function(successCallback){
    exec(successCallback, failureCallback, 'BaiduPush', 'messageGet', []);
};
